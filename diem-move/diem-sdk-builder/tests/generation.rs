...
use diem_sdk_builder as buildgen;
use diem_types::transaction::EntryABI;
...
#[test]
// Ignored because transactions require minting/transfering Coin<DiemCoin>, which the
...
fn test_that_rust_entry_fun_code_compiles() {
    ...
    let abis = vec![];
    test_rust(
        &abis, // &diem_cached_packages::head_release_bundle().abis(),
