...
pub enum InputOptions {
    FromDirectory {
        /// Path to the local testnet folder. If you are running local testnet via cli, it should be `.diem/testnet`.
        #[clap(short, long)]
        test_dir: PathBuf,
    },
    FromArgs {
...
async fn main() {
    ...
    initialize_diem_core_path(args.diem_core_path.clone());
    ...
    match args.cmd {
        Commands::GenerateProposals {
            release_config,
            output_dir,
        } => diem_release_builder::ReleaseConfig::load_config(release_config.as_path())
            ...
            .unwrap(),
        Commands::WriteDefault { output_path } => diem_release_builder::ReleaseConfig::default()
        ...
        Commands::ValidateProposals {
            ...
            let mut network_config = match input_option {
                ...
                InputOptions::FromArgs {
                    ...
                    diem_release_builder::validate::NetworkConfig {
                        root_key_path,
                        validator_account,
                        validator_key,
            ...
            if mint_to_validator {
                let chain_id = diem_rest_client::Client::new(endpoint)
            ...
            network_config
                ...
                .await
                .unwrap();
            diem_release_builder::validate::validate_config_and_generate_release(
                config,
