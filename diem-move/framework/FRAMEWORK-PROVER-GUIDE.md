This guide gives some hints to troubleshoot issues when using the prover for specifying the Diem frameworks.

## Installation

Please refer to the [doc](https://diem.dev/tools/install-cli/install-move-prover/).
...
you could use the command `cargo test --release -p diem-framework -- --skip prover`.


## Specification guide

Please refer to the [Move Prover Book](https://diem.dev/guides/prover-guides/move-prover)
