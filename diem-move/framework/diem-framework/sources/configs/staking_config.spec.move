spec diem_framework::staking_config {
    spec module {
        use diem_framework::chain_status;
        invariant chain_status::is_operating() ==> exists<StakingConfig>(@diem_framework);
        pragma verify = ture;
    ...
    spec get(): StakingConfig {
        aborts_if !exists<StakingConfig>(@diem_framework);
    }
    ...
    spec calculate_and_save_latest_epoch_rewards_rate(): FixedPoint64 {
        ...
        aborts_if !exists<StakingRewardsConfig>(@diem_framework);
    ...
    spec update_rewards_config(
        ...
        include StakingRewardsConfigRequirement;
        let addr = signer::address_of(diem_framework);
        let staking_reward_config = borrow_global<StakingRewardsConfig>(@diem_framework);
    ...
    spec schema StakingRewardsConfigEnabledRequirement {
        requires exists<StakingRewardsConfig>(@diem_framework);
        let staking_rewards_config = global<StakingRewardsConfig>(@diem_framework);
