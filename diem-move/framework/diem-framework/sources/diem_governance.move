...
module diem_framework::diem_governance {
    ...
    public fun initialize_partial_voting(
        ...
        move_to(diem_framework, VotingRecordsV2 {
    ...
    public fun has_entirely_voted(stake_pool: address, proposal_id: u64): bool acquires VotingRecords {
        ...
        let voting_records = borrow_global<VotingRecords>(@diem_framework);
    ...
    public fun create_proposal_v2_impl(
        ...
        let total_voting_token_supply = coin::supply<DiemCoin>();
    ...
    public entry fun vote(
        ...
        proposal_id: u64,
        should_pass: bool,
    ) acquires ApprovedExecutionHashes, GovernanceEvents, VotingRecords, VotingRecordsV2 {
    ...
    fun vote_internal(
        ...
        if (features::partial_governance_voting_enabled()) {
            let voting_records_v2 = borrow_global_mut<VotingRecordsV2>(@diem_framework);
    ...
    fun assert_voting_initialization() {
        if (features::partial_governance_voting_enabled()) {
            assert!(exists<VotingRecordsV2>(@diem_framework), error::invalid_state(EPARTIAL_VOTING_NOT_INITIALIZED));
        };
    }
    ...
    public entry fun test_voting_generic(
    ...
    ) acquires ApprovedExecutionHashes, GovernanceConfig, GovernanceEvents, GovernanceResponsbility, VotingRecords, VotingRecordsV2 {
        ...
        test_resolving_proposal_generic(diem_framework, use_generic_resolve_function, execution_hash);
    }
    ...
    public entry fun test_stake_pool_can_vote_on_partial_voting_proposal_many_times(
        ...
        setup_partial_voting(&diem_framework, &proposer, &voter_1, &voter_2);
        let execution_hash = vector::empty<u8>();
        vector::push_back(&mut execution_hash, 1);
        ...
        test_resolving_proposal_generic(diem_framework, true, execution_hash);
    }
    ...
    public entry fun test_stake_pool_can_vote_before_and_after_partial_governance_voting_enabled(
        ...
        initialize_partial_voting(&diem_framework);
        features::change_feature_flags(&diem_framework, vector[features::get_partial_governance_voting()], vector[]);

        coin::register<DiemCoin>(&voter_1);
        coin::register<DiemCoin>(&voter_2);
    ...
    public entry fun test_no_remaining_voting_power_about_proposal_expiration_time(
        ...
        voter_1: signer,
        voter_2: signer,
    ) acquires GovernanceConfig, GovernanceEvents, GovernanceResponsbility, VotingRecords, VotingRecordsV2 {
        setup_voting_with_initialized_stake(&diem_framework, &proposer, &voter_1, &voter_2);
        let execution_hash = vector::empty<u8>();
        vector::push_back(&mut execution_hash, 1);
        let proposer_addr = signer::address_of(&proposer);
        let voter_1_addr = signer::address_of(&voter_1);
    ...
    public fun setup_voting(
        ...
        initialize(diem_framework, 10, 100, 1000);
        store_signer_cap(
            diem_framework,
            @diem_framework,
    ...
    public fun setup_voting_with_initialized_stake(
        ...
        // Initialize the governance.
        stake::initialize_for_test_custom(diem_framework, 0, 1000, 2000, true, 0, 1, 1000);
        initialize(diem_framework, 10, 100, 1000);
        store_signer_cap(
            diem_framework,
            @diem_framework,
    ...
    public entry fun test_replace_execution_hash(
        ...
        yes_voter: signer,
        no_voter: signer,
    ) acquires GovernanceResponsbility, GovernanceConfig, GovernanceEvents, ApprovedExecutionHashes, VotingRecords, VotingRecordsV2 {
        setup_voting(&diem_framework, &proposer, &yes_voter, &no_voter);
