...
module diem_framework::primary_fungible_store {
    use diem_framework::fungible_asset::{Self, FungibleAsset, FungibleStore, Metadata, MintRef, TransferRef, BurnRef};
    ...
    #[test_only]
    use diem_framework::fungible_asset::{create_test_token, generate_mint_ref, generate_burn_ref, generate_transfer_ref};
    #[test_only]
    use std::string;
    #[test_only]
    use std::option;
