...
module diem_framework::object {
    ...
    fun test_correct_auid(fx: signer) {
        ...
        let auid1 = diem_framework::transaction_context::generate_auid_address();
        let bytes = diem_framework::transaction_context::get_transaction_hash();
        ...
        let auid2 = diem_framework::from_bcs::to_address(std::hash::sha3_256(bytes));
