...
use crate::{
    ...
    zip_metadata, zip_metadata_str, RuntimeModuleMetadataV1, DIEM_METADATA_KEY,
    DIEM_METADATA_KEY_V1, METADATA_V1_MIN_FILE_FORMAT_VERSION,
};
use anyhow::bail;
use diem_types::{account_address::AccountAddress, transaction::EntryABI};
use clap::Parser;
                    ...
                    if !module_metadata.is_empty() {
                            ...
                            >= METADATA_V1_MIN_FILE_FORMAT_VERSION
                        {
                            ...
                            named_module.module.metadata.push(Metadata {
                                key: DIEM_METADATA_KEY_V1.to_vec(),
