...
///
module diem_token_objects::token {
    use std::error;
    ...
    use diem_token_objects::collection::{Self, Collection};
    use diem_token_objects::royalty::{Self, Royalty};
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x20002, location = diem_token_objects::collection)]
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x80001, location = diem_framework::object)]
