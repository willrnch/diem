/// `PropertyMap` provides generic metadata support for `DiemToken`. It is a specialization of
...
module diem_token_objects::property_map {
    use std::bcs;
    use std::vector;
    use std::error;
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x10001, location = diem_std::from_bcs)]
