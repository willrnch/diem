...
pub fn diem_test_natives() -> NativeFunctionTable {
...
fn move_framework_unit_tests() {
    run_tests_for_pkg("diem-framework");
}

#[test]
fn move_diem_stdlib_unit_tests() {
    run_tests_for_pkg("diem-stdlib");
}
...
fn move_token_unit_tests() {
    run_tests_for_pkg("diem-token");
}

#[test]
fn move_token_objects_unit_tests() {
    run_tests_for_pkg("diem-token-objects");
}
