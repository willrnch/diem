...
module token_objects::food {
    ...
    use diem_framework::fungible_asset::{Self, Metadata};
    ...
    fun init_module(sender: &signer) {
        ...
        create_food_token_as_fungible_token(
            ...
            string::utf8(b"https://raw.githubusercontent.com/aptos-labs/diem-core/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Corn"),
            string::utf8(b"Corn"),
            string::utf8(b"CORN"),
            string::utf8(b"https://raw.githubusercontent.com/aptos-labs/diem-core/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Corn.png"),
            string::utf8(b"https://www.diemlabs.com"),
            5,
        );
        create_food_token_as_fungible_token(
            sender,
            ...
            string::utf8(b"https://raw.githubusercontent.com/aptos-labs/diem-core/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Meat"),
            string::utf8(b"Meat"),
            string::utf8(b"MEAT"),
            string::utf8(b"https://raw.githubusercontent.com/aptos-labs/diem-core/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Meat.png"),
            string::utf8(b"https://www.diemlabs.com"),
            20,
        );
    }
