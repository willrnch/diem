...
module example_addr::managed_fungible_token {
    use diem_framework::fungible_asset::Metadata;
    use diem_framework::object::{Self, Object};
    use std::string::{utf8, String};
    use std::option;
    use diem_token_objects::token::{create_named_token, create_token_seed};
    use diem_token_objects::collection::create_fixed_collection;
    ...
    fun init_module(admin: &signer) {
        ...
        create_fixed_collection(
            ...
            collection_name,
            option::none(),
            utf8(b"http://diemlabs.com/collection"),
        );
        let constructor_ref = &create_named_token(admin,
            ...
            token_name,
            option::none(),
            utf8(b"http://diemlabs.com/token"),
        );
