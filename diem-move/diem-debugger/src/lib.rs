...
use diem_validator_interface::{
    DiemValidatorInterface, DBDebuggerInterface, DebuggerStateView, RestDebuggerInterface,
};
use diem_vm::{
...
impl DiemDebugger {
    pub fn new(debugger: Arc<dyn DiemValidatorInterface + Send>) -> Self {
        Self { debugger }
    }
    ...
    pub fn execute_transactions_at_version(
        ...
        DiemVM::execute_block(txns, &state_view, None)
