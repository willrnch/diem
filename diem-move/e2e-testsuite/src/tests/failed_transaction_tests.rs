...
use diem_gas::{
    DiemGasParameters, StandardGasMeter, StorageGasParameters, LATEST_GAS_FEATURE_VERSION,
};
...
use diem_vm::{data_cache::AsMoveResolver, transaction_metadata::TransactionMetadata, DiemVM};
...
fn failed_transaction_cleanup_test() {
    ...
    let gas_params = DiemGasParameters::zeros();
