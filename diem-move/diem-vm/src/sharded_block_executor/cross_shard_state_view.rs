...
use diem_state_view::{StateView, TStateView};
use diem_types::{
...
mod tests {
    ...
    use diem_state_view::{in_memory_state_view::InMemoryStateView, TStateView};
    use diem_types::state_store::{state_key::StateKey, state_value::StateValue};
