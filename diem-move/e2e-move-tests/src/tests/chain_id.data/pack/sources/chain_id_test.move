module 0x1::chain_id_test {
    ...
    fun init_module(sender: &signer) {
        ...
        features::change_feature_flags(sender, vector[features::get_diem_stdlib_chain_id_feature()], vector[]);
    }

    /// Fetches the chain ID (via diem_framework::chain_id::get()) and stores it in the ChainIdStore resource.
    public entry fun store_chain_id_from_diem_framework(_s: &signer) acquires ChainIdStore {
