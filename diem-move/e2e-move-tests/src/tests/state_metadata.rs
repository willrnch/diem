...
fn test_track_slot_payer() {
    ...
    let coin_store = parse_struct_tag("0x1::coin::CoinStore<0x1::diem_coin::DiemCoin>").unwrap();
    ...
    harness.run_transaction_payload(
        &account1,
        diem_cached_packages::diem_stdlib::diem_account_transfer(address2, 100),
    );
    ...
    harness.run_transaction_payload(
        &account1,
        diem_cached_packages::diem_stdlib::diem_account_transfer(address3, 100),
    );
