...
use diem_framework::natives::GasParameters;

crate::natives::define_gas_parameters_for_natives!(GasParameters, "diem_framework", [
    ...
    // These are dummy value, they copied from storage gas in diem-core/diem-vm/src/diem_vm_impl.rs
