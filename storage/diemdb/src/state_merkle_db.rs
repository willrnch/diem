...
use anyhow::Result;
use diem_config::config::{RocksdbConfig, RocksdbConfigs};
...
use diem_rocksdb_options::gen_rocksdb_options;
...
pub(crate) type LeafNode = diem_jellyfish_merkle::node_type::LeafNode<StateKey>;
pub(crate) type Node = diem_jellyfish_merkle::node_type::Node<StateKey>;
type NodeBatch = diem_jellyfish_merkle::NodeBatch<StateKey>;
