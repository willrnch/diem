...
use anyhow::Result;
use diem_config::config::RocksdbConfigs;
use diem_types::nibble::{nibble_path::NibblePath, Nibble};
use clap::Parser;
...
impl DbDir {
    ...
    pub fn open_state_merkle_db(&self) -> Result<diem_schemadb::DB> {
        diem_schemadb::DB::open_cf_readonly(
            &diem_schemadb::Options::default(),
