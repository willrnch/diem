...
//! This module defines representation of DiemDB indexer data structures at physical level via schemas
//! that implement [`diem_schemadb::schema::Schema`].
//!
...
use diem_schemadb::ColumnFamilyName;
