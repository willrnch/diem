...
use diem_types::{on_chain_config::TimedFeatureOverride, transaction::Version};
use diem_vm::DiemVM;
use std::sync::Arc;
...
impl ReplayVerifyCoordinator {
    ...
    async fn run_impl(self) -> Result<()> {
        DiemVM::set_concurrency_level_once(self.replay_concurrency_level);
        DiemVM::set_timed_feature_override(TimedFeatureOverride::Replay);
