...
use crate::{
    KeyCodec, Schema, SeekKeyCodec, ValueCodec, DIEM_SCHEMADB_ITER_BYTES,
    DIEM_SCHEMADB_ITER_LATENCY_SECONDS, DIEM_SCHEMADB_SEEK_LATENCY_SECONDS,
};
use anyhow::Result;
    ...
    S: Schema,
{
    ...
    pub fn seek_to_first(&mut self) {
        let _timer = DIEM_SCHEMADB_SEEK_LATENCY_SECONDS
