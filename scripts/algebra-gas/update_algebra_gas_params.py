...
# so this should be larger than `LATEST_GAS_FEATURE_VERSION` in `diem-move/diem-gas/src/gas_meter.rs`.
...
def main(gas_per_ns):
    path = Path('diem-move/diem-gas/src/diem_framework.rs')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='Generate gas parameters for algebra module in `diem-move/diem-gas/src/diem_framework.rs`.')
