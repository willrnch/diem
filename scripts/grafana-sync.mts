...
const GRAFANA_URL = process.env.GRAFANA_URL ?? "https://diemlabs.grafana.net";
const GRAFANA_DASHBOARD_FOLDER_NAME_TO_SYNC = process.env.GRAFANA_DASHBOARD_FOLDER_NAME_TO_SYNC ?? "diem-core";
