# This script installs the necessary dependencies to build in Diem.
...
function welcome_message {
    $message = "`nWelcome to Diem!
    `nThis script will download and install the necessary dependencies for Diem Core based on your selection:
      * Install Diem build tools: t
...
function build_tools_message {
    ...
    `nThis script will download and install the following dependencies needed to build Diem Core if not found on your system:
...
function update_versions {
  try {    
    ...
    $url = "https://raw.githubusercontent.com/aptos-labs/diem-core/main/scripts/dev_setup.sh"
