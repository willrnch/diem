...
const ADDITIONAL_EMAIL_TO_USERNAME = Object.freeze({
  "109111707+zihan-diem@users.noreply.github.com": "0xZihan",
  "128556004+jin-diem@users.noreply.github.com": "0xjinn",
  "alex@alexs-macbook-pro.local": "markuze",
  "raj@diemlabs.com": "rajkaramchedu",
...
async function fetchEmailToUsernameViaCommit(email, docRoot) {
  ...
  let query = `
    query {
      repository(owner: "aptos-labs", name: "diem-core") {
        object(oid: "${commit}") {
          ... on Commit {
            author {
              user {
