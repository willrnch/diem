...
1. Go to the [Diem Explorer](https://explorer.diemlabs.com/) in a web browser>
...
The earlier examples demonstrate how users directly mint NFTs. Diem also supports airdropping via a two step process:
