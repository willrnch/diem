...
This guide describes how to run a local network with multiple validator nodes and validator fullnodes. You will use the [Diem Forge CLI](https://github.com/aptos-labs/diem-core/tree/main/testsuite/forge-cli/src) for this.
...
This guide assumes you have done the steps in [Building Diem From Source](building-from-source.md)
...
Also see how to use the [Diem CLI](../tools/diem-cli-tool/use-diem-cli.md#account-examples) with an existing faucet.
:::
