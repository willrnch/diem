...
This document describes the coding guidelines for the [Diem Core](https://github.com/aptos-labs/diem-core) Rust codebase. For the Move language, see the [Move Coding Conventions](../move/book/coding-conventions.md).
...
* top-level directories (e.g. `diem-core/network`, `diem-core/language`)
...
A good example of README.md is `diem-core/network/README.md` that describes the networking crate.
