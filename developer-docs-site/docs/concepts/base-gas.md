...
Diem transactions by default charge a base gas fee, regardless of market conditions.
...
As explained in the [optimization principles](#optimization-principles) section, storage gas has by far the largest effect on base gas. For background on the Diem gas model, see [The Making of the Diem Gas Schedule](https://diemlabs.medium.com/the-making-of-the-diem-gas-schedule-508d5686a350).
...
Additional storage gas parameters are defined in [`table.rs`], [`move_stdlib.rs`], and other assorted source files in [`diem-gas/src/`].
...
Payload gas is defined in [`transaction/mod.rs`](https://github.com/aptos-labs/diem-core/blob/main/diem-move/diem-gas/src/transaction/mod.rs), which incorporates storage gas with several payload- and pricing-associated parameters:
...
As of the time of this writing, `min_price_per_gas_unit` in [`transaction/mod.rs`](https://github.com/aptos-labs/diem-core/blob/main/diem-move/diem-gas/src/transaction/mod.rs) is defined as [`diem_global_constants`]`::GAS_UNIT_PRICE` (which is itself defined as 100), with other noteworthy [`transaction/mod.rs`](https://github.com/aptos-labs/diem-core/blob/main/diem-move/diem-gas/src/transaction/mod.rs) constants as follows:
...
As of the time of this writing, [`transaction/mod.rs`](https://github.com/aptos-labs/diem-core/blob/main/diem-move/diem-gas/src/transaction/mod.rs) defines the minimum amount of internal gas per transaction as 1,500,000 internal units (15,000 octas at minimum), an amount that increases by 2,000 internal gas units (20 octas minimum) per byte for payloads larger than 600 bytes, with the maximum number of bytes permitted in a transaction set at 65536.
Hence in practice, payload gas is unlikely to be a concern.

<!--- Alphabetized reference links -->

[#4540]:                           https://github.com/aptos-labs/diem-core/pull/4540/files
[`diem-gas/src/`]:                https://github.com/aptos-labs/diem-core/blob/main/diem-move/diem-gas/src/
[`diem_global_constants`]:        https://github.com/aptos-labs/diem-core/blob/main/config/global-constants/src/lib.rs
[`base_8192_exponential_curve()`]: https://github.com/aptos-labs/diem-core/blob/main/diem-move/framework/diem-framework/doc/storage_gas.md#0x1_storage_gas_base_8192_exponential_curve
[BCS sequence specification]:      https://github.com/diem/bcs#fixed-and-variable-length-sequences
[`gas_meter.rs`]:                  https://github.com/aptos-labs/diem-core/blob/main/diem-move/diem-gas/src/gas_meter.rs
[`initialize()`]:                  https://github.com/aptos-labs/diem-core/blob/main/diem-move/framework/diem-framework/doc/storage_gas.md#0x1_storage_gas_initialize
[`instr.rs`]:                      https://github.com/aptos-labs/diem-core/blob/main/diem-move/diem-gas/src/instr.rs
[`move_stdlib.rs`]:                https://github.com/aptos-labs/diem-core/blob/main/diem-move/diem-gas/src/move_stdlib.rs
[`on_reconfig()`]:                 https://github.com/aptos-labs/diem-core/blob/main/diem-move/framework/diem-framework/doc/storage_gas.md#@Specification_16_on_reconfig
[`storage_gas.md`]:                https://github.com/aptos-labs/diem-core/blob/main/diem-move/framework/diem-framework/doc/storage_gas.md
[`storage_gas.move`]:              https://github.com/aptos-labs/diem-core/blob/main/diem-move/framework/diem-framework/sources/storage_gas.move
[`StorageGas`]:                    https://github.com/aptos-labs/diem-core/blob/main/diem-move/framework/diem-framework/doc/storage_gas.md#resource-storagegas
[`table.rs`]:                      https://github.com/aptos-labs/diem-core/blob/main/diem-move/diem-gas/src/table.rs
[`transaction.rs`]:                https://github.com/aptos-labs/diem-core/blob/main/diem-move/diem-gas/src/transaction.rs
