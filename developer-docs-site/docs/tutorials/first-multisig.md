...
```zsh
cd <diem-core-parent-directory>/diem-core/ecosystem/python/sdk/
```
...
Move source code for this section is found in the [`upgrade_and_govern`](https://github.com/aptos-labs/diem-core/tree/main/diem-move/move-examples/upgrade_and_govern) directory.
...
```zsh title=Output
=== Genesis publication ===
Running diem CLI command: diem move compile --save-metadata --package-dir ../../../../diem-move/move-examples/upgrade_and_govern/genesis --named-addresses upgrade_and_govern=0xdd86860ae7f77f58d08188e1c39fbc6a2f7cec782f09f6767f8367d84357ed57
...
```zsh title=Output
=== Upgrade publication ===
Running diem CLI command: diem move compile --save-metadata --package-dir ../../../../diem-move/move-examples/upgrade_and_govern/upgrade --named-addresses upgrade_and_govern=0xdd86860ae7f77f58d08188e1c39fbc6a2f7cec782f09f6767f8367d84357ed57
