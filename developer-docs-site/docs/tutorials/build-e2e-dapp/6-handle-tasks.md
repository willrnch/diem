...
In the sixth and final chapter of the tutorial on [building an end-to-end dapp on Diem](./index.md), you will add functionality to the app so the user interface is able to handle cases where an account has created a list.
            ...
            renderItem={(task: any) => (
              <List.Item actions={[<Checkbox />]}>
                <List.Item.Meta
                  ...
                  description={
                    <a
                      href={`https://explorer.diemlabs.com/account/${task.address}/`}
                      target="_blank"
...
You have now learned how to build a dapp on Diem from end to end. Congratulations! Tell your friends. :-)
