...
The Diem network is comprised of nodes of three types: validator node, validator fullnode and public fullnode. To participate in consensus, you are required to run both a validator node and a validator fullnode, and stake.
  ...
  <div class="row row-cols-1 row-cols-md-2a g-4">
    <div class="col">
      <div class="card-no-border card-body h-100 d-flex flex-column align-items-start">
        <div class="card-body">
          <h2 class="card-title">Validation on Diem</h2>
          <p class="card-text">
            Everything you need to know about how validation, staking and governance works on Diem.
          </p>
        </div>
        <div class="list-group list-group-flush">
          <a href="../concepts/staking#validation-on-the-diem-blockchain" class="list-group-item">
          ...
          <a href="../concepts/staking" class="list-group-item">
            <div class="d-flex w-100 justify-content-between">
              <h4 class="mb-1">Staking on Diem</h4>
            </div>
            <small>A comprehensive guide to how staking works on Diem.</small>
          </a>
      ...
      <div class="card-no-border card-body h-100 d-flex flex-column">
        ...
        <div class="list-group list-group-flush">
          ...
          <a href="./validator-node/operator/node-liveness-criteria" class="list-group-item">
            ...
            <small>Your nodes must pass these liveness criteria to be in an Diem network.</small>
          </a>
          <a href="./validator-node/operator/connect-to-diem-network" class="list-group-item">
            <div class="d-flex w-100 justify-content-between">
              <h4 class="mb-1">Connecting to Diem network</h4>
            </div>
            <small>Steps to connect your nodes to an Diem network. </small>
          </a>
    ...
    <div class="col">
      <div class="card-no-border card-body h-100 d-flex flex-column">
        <div class="card-body">
          ...
          <p class="card-text">
            A section with detailed, step-by-step instructions on everything related to Diem fullnode. 
          </p>
        </div>
        <div class="list-group list-group-flush">
          ...
          <a href="./indexer-fullnode" class="list-group-item">
            ...
            <small
              >Describes how to run an indexer fullnode on the Diem network. </small>
          </a>
      ...
      <div class="card-no-border card-body h-100 d-flex flex-column">
        ...
        <div class="list-group list-group-flush">
          <a href="./deployments" class="list-group-item">
            <div class="d-flex w-100 justify-content-between">
              <h4 class="mb-1">Diem blockchain deployments</h4>
            </div>
            <small>See a snapshot of all Diem deployments.</small>
          </a>
          ...
          <a href="../integration/indexing" class="list-group-item">
            ...
            <small>Access Diem-provided indexer service or build your own custom indexer for the Diem blockchain.</small>
          </a>
          <a href="../guides/state-sync" class="list-group-item">
            <div class="d-flex w-100 justify-content-between">
              <h4 class="mb-1">State synchronization</h4>
            </div>
            <small>Synchronize your nodes to the latest Diem blockchain state.</small>
          </a>
        </div>
      </div>
    </div>
