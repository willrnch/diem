...
This is a step-by-step guide to install an Diem node on Amazon Web Services (AWS). Follow these steps to configure a validator node and a validator fullnode on separate machines. 
...
4. Modify the `main.tf` file to configure Terraform and to create Diem fullnode from the Terraform module. See below example content for `main.tf`:
    ...
    module "diem-node" {
      ...
      source        = "github.com/aptos-labs/diem-core.git//terraform/diem-node/aws?ref=mainnet"
    ...
    For full customization options, see:
      - The Terraform variables file [https://github.com/aptos-labs/diem-core/blob/main/terraform/diem-node/aws/variables.tf](https://github.com/aptos-labs/diem-core/blob/main/terraform/diem-node/aws/variables.tf), and 
      - The values YAML file [https://github.com/aptos-labs/diem-core/blob/main/terraform/helm/diem-node/values.yaml](https://github.com/aptos-labs/diem-core/blob/main/terraform/helm/diem-node/values.yaml).
