...
[Coin](https://github.com/aptos-labs/diem-core/blob/main/diem-move/framework/diem-framework/sources/coin.move) provides a standard, typesafe framework for simple, fungible tokens or coins. 
...
The following tables describe fields at the struct level. For the definitive list, see the [Diem Framework](https://github.com/aptos-labs/diem-core/blob/main/diem-move/framework/diem-framework/doc/overview.md) containing [`coin`](https://github.com/aptos-labs/diem-core/blob/main/diem-move/framework/diem-framework/doc/coin.md).

##### [`Coin`](https://github.com/aptos-labs/diem-core/blob/744c2def47cddced878fda9bbd5633022fdb083a/diem-move/framework/diem-framework/sources/coin.move#L68)

| Field | Type | Description |
| --- | --- | --- |
| `value` | u64 | Value of the token, eg: 1000000000 |

##### [`CoinInfo`](https://github.com/aptos-labs/diem-core/blob/744c2def47cddced878fda9bbd5633022fdb083a/diem-move/framework/diem-framework/sources/coin.move#L92)

| Field | Type | Description |
| --- | --- | --- |
| `name` | String | Name of the token, eg: Diem Coin |
