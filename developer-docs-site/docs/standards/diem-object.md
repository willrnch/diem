...
The existing Diem data model emphasizes the use of the store ability within Move. Store allows for a struct to exist within any struct that is stored on-chain. As a result, data can live anywhere within any struct and at any address. While this provides great flexibility it has many limitations:
...
:::tip
Object is a core primitive in Diem Move and created via the object module at 0x1::object
:::
...
```rust
use diem_framework::object::Object;
use diem_framework::fungible_asset::FungibleAsset;
...
```rust
use diem_framework::object::{Object, DeleteRef};
...
```rust
use diem_framework::object::{Object, TransferRef};
