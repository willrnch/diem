...
- [Move Stdlib](https://github.com/aptos-labs/diem-core/tree/main/diem-move/framework/move-stdlib)
- [Diem Stdlib](https://github.com/aptos-labs/diem-core/tree/main/diem-move/framework/diem-stdlib)
- [Diem Framework](https://github.com/aptos-labs/diem-core/tree/main/diem-move/framework/diem-framework)
...
- [`hello_prover` example](https://github.com/aptos-labs/diem-core/tree/main/diem-move/move-examples/hello_prover)
...
- [The Move Tutorial, steps 7 and 8](https://github.com/aptos-labs/diem-core/tree/main/diem-move/move-examples/move-tutorial#step-7--use-the-move-prover)
- [Verify Smart Contracts in Diem with the Move Prover by MoveBit](https://www.movebit.xyz/blog/post/move-prover-tutorial-part-1.html)
