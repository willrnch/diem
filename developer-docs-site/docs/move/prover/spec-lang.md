...
the [Diem framework](https://github.com/aptos-labs/diem-core/blob/main/diem-move/framework/diem-framework/doc/overview.md) documentation, which has specifications embedded.
...
* [DIEM_FRAMEWORK](https://github.com/aptos-labs/diem-core/blob/main/diem-move/framework/diem-framework/doc/overview.md)
