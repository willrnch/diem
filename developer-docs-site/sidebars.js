...
const sidebars = {
  ...
  diemSidebar: [
    ...
    },
    {
      ...
      collapsible: true,
      collapsed: true,
      link: { type: "doc", id: "diem-white-paper/index" },
      items: ["diem-white-paper/in-korean"],
    },
    {
      type: "category",
      ...
      items: [
        {
          type: "category",
          label: "Diem Blockchain Deep Dive",
  ...
  appSidebar: [
    ...
    },
    {
      ...
      link: { type: "doc", id: "move/move-on-diem" },
      collapsible: true,
      collapsed: true,
      items: [
        {
          ...
          collapsed: true,
          items: [
            "move/move-on-diem/resource-accounts",
            "move/move-on-diem/modules-on-diem",
            "move/move-on-diem/move-scripts",
            "move/move-on-diem/cli",
          ],
        },
        {
          type: "category",
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        "standards/diem-object",
        "standards/diem-coin",
        "standards/fungible-asset",
        "standards/diem-token-v2",
        "standards/diem-token",
        "standards/wallets",
      ],
    },
    {
      ...
      items: [
        ...
        "integration/diem-names-service-package",
        "integration/handle-diem-errors",
      ],
    },
    {
      type: "category",
      ...
      items: [
          ...
          items: [
            {
              ...
              items: [
                "sdks/ts-sdk/typescript-sdk-overview",
                {
                  ...
                  collapsible: true,
                  collapsed: true,
                  items: ["sdks/ts-sdk/diem-client", "sdks/ts-sdk/indexer-client"],
                },
        ...
        "tools/diem-cli-tool/use-diem-cli",
    ...
    {
      type: "category",
      label: "Build E2E Dapp with Diem",
    ...
    },
    {
      ...
      link: {
        ...
        description: "Take the next step into building complex applications on Diem.",
  ...
  nodeSidebar: [
    ...
    "nodes/nodes-landing",
    {
      ...
      items: [
        ...
        "nodes/validator-node/operator/connect-to-diem-network",
    ...
    },
    {
      ...
      items: [
        ...
        "nodes/full-node/diem-db-restore",
