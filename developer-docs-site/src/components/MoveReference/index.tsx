...
const root = "https://raw.githubusercontent.com/aptos-labs/diem-core/";
...
const frameworks = ["move-stdlib", "diem-stdlib", "diem-framework", "diem-token", "diem-token-objects"];
  ...
  useEffect(() => {
    const fetchContent = async () => {
      ...
      for (const framework of frameworks) {
        const page = `${root}/${branch}/diem-move/framework/${framework}/doc/overview.md`;
...
const Content = ({ branch, page }: ContentProps) => {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      ...
      const page_path = `${root}/${branch}/diem-move/framework/${page}`;
...
const Main = () => {
  ...
  if (ExecutionEnvironment.canUseViewport) {
    ...
    page = params.get("page") ?? "diem-framework/doc/overview.md";
