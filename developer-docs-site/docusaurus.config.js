...
const config = {
  ...
  projectName: "diem-core", // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: "https://github.com/aptos-labs/diem-core/tree/main/developer-docs-site/",
  ...
  themeConfig: {
    ...
    image: "img/diem_meta_og_diem-foundation_docs.jpg",
    colorMode: {
      defaultMode: "dark",
    },
    docs: {
    ...
    navbar: {
      logo: {
        alt: "Diem Labs Logo",
        src: "img/diem_word.svg",
        srcDark: "img/diem_word_dark.svg",
      },
      items: [
        {
          href: "https://github.com/aptos-labs/diem-core/",
          label: "GitHub",
          position: "right",
        },
        {
          ...
          items: [
            {
              label: "Read the Diem White Paper",
              to: "diem-white-paper",
              activeBaseRegex: "^/diem-white-paper$|^/diem-white-paper$",
            },
            {
              label: "Learn about Diem",
              to: "concepts",
            },
            {
              label: "Explore Diem",
              to: "guides/explore-diem",
            },
            {
              label: "Latest Releases",
              to: "releases/diem-releases",
            },
            {
              label: "Deployments",
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              to: "move/move-on-diem",
            },
            {
              label: "Embrace the Diem Standards",
              to: "standards",
            },
            {
              label: "Integrate with Diem",
            ...
            {
              label: "Create NFTs on Diem",
              to: "/category/nft",
            },
            {
              label: "Build E2E Dapp on Diem",
        ...
        },
        {
          type: "dropdown",
          label: "Reference",
          to: "nodes/diem-api-spec",
          position: "left",
          items: [
            {
              label: "Diem REST API Spec",
              to: "nodes/diem-api-spec",
            },
            {
              label: "Diem Move Framework",
              to: "reference/move",
            },
            {
              label: "Diem Glossary",
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Update Diem.dev",
              to: "community/site-updates",
            },
            {
              label: "Follow Diem Style",
              to: "community/diem-style",
            },
            {
              label: "Contributors",
          ...
          items: [
            {
              html: `
                <div class="footer-left">
                  <a class="footer-logo" href="https://diemfoundation.org" target="_blank" rel="noopener noreferrer" title="Diem Foundation">
                  ...
                  <div class="copyright">
                    <p class="copyright-text">© 2022 Diem Foundation</p>
                    <div class="copyright-links">
                      <a href="https://diemfoundation.org/privacy" target="_blank">Privacy</a>
                      <a href="https://diemfoundation.org/terms" target="_blank">Terms</a></div>
                  </div>
                </div>
                `,
            },
              ...
              html: `
                  <p class="right">
                    <nav class="social-links">
                        ...
                        <a class="social-link" href="https://discord.gg/diemnetwork" target="_blank" rel="noopener noreferrer" title="Discord">
                        ...
                        <a class="social-link" href="https://twitter.com/Diem_Network" target="_blank" rel="noopener noreferrer" title="Twitter">
    ...
    [
      "@docusaurus/plugin-client-redirects",
      {
        redirects: [
          ...
          {
            to: "/diem-white-paper",
            from: "/diem-white-paper/diem-white-paper-index/",
          },
          {
            to: "/guides/system-integrators-guide",
          ...
          {
            to: "/move/move-on-diem",
            from: "/guides/move-guides/diem-move-guides",
          },
        ],
