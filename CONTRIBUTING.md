---
id: contributing
title: Contributing to Diem Core
---

# Contributing

Our goal is to make contributing to Diem Core easy and transparent. See [Diem Community](https://diem.dev/community) for full details. This page describes [our development process](#our-development-process).

## Diem Core

To contribute to the Diem Core implementation, first start with the proper development copy.
You may want to use the GitHub interface to fork [diem-core](https://github.com/aptos-labs/diem-core) and check out your fork.
For development environment setup and first build, see [Building Diem From Source](https://diem.dev/guides/building-from-source)
...
Diem Core's developer website is also open source (the code can be found in this [repository](https://github.com/aptos-labs/diem-core/tree/main/developers-docs-site/).  It is built using [Docusaurus](https://docusaurus.io/):
...
Diem Core uses [GitHub issues](https://github.com/aptos-labs/diem-core/issues) to track bugs. Please include necessary information and instructions to reproduce your issue.
