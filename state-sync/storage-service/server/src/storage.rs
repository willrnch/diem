...
use diem_storage_service_types::responses::{
...
pub trait StorageReaderInterface: Clone + Send + 'static {
    ...
    fn get_data_summary(&self) -> diem_storage_service_types::Result<DataSummary, Error>;
    ...
    fn get_transactions_with_proof(
        ...
        end_version: u64,
        include_events: bool,
    ) -> diem_storage_service_types::Result<TransactionListWithProof, Error>;
    ...
    ) -> diem_storage_service_types::Result<EpochChangeProof, Error>;
    ...
    fn get_transaction_outputs_with_proof(
        ...
        start_version: u64,
        end_version: u64,
    ) -> diem_storage_service_types::Result<TransactionOutputListWithProof, Error>;
    ...
    ) -> diem_storage_service_types::Result<TransactionOrOutputListWithProof, Error>;

    /// Returns the number of states in the state tree at the specified version.
    fn get_number_of_states(&self, version: u64)
        -> diem_storage_service_types::Result<u64, Error>;
    ...
    fn get_state_value_chunk_with_proof(
        ...
        start_index: u64,
        end_index: u64,
    ) -> diem_storage_service_types::Result<StateValueChunkWithProof, Error>;
}
...
impl StorageReader {
    ...
    ) -> diem_storage_service_types::Result<Option<CompleteDataRange<Version>>, Error> {
...
/// `end == u64::MAX`.
fn inclusive_range_len(start: u64, end: u64) -> diem_storage_service_types::Result<u64, Error> {
    // len = end - start + 1
...
) -> diem_storage_service_types::Result<(bool, u64), Error> {
