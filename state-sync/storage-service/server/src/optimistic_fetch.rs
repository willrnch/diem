...
impl OptimisticFetchRequest {
    ...
    ) -> diem_storage_service_types::Result<StorageServiceRequest, Error> {
...
pub(crate) fn get_peers_with_ready_optimistic_fetches<T: StorageReaderInterface>(
    ...
    storage: T,
    time_service: TimeService,
) -> diem_storage_service_types::Result<Vec<(PeerNetworkId, LedgerInfoWithSignatures)>, Error> {
...
fn get_epoch_ending_ledger_info<T: StorageReaderInterface>(
    ...
    storage: T,
    time_service: TimeService,
) -> diem_storage_service_types::Result<LedgerInfoWithSignatures, Error> {
...
fn notify_peer_of_new_data<T: StorageReaderInterface>(
    ...
    target_ledger_info: LedgerInfoWithSignatures,
) -> diem_storage_service_types::Result<(), Error> {
