...
use diem_logger::{debug, error, sample, sample::SampleRate, trace, warn};
...
impl<T: StorageReaderInterface> Handler<T> {
    ...
    ) -> diem_storage_service_types::Result<StorageServiceResponse> {
    ...
    pub(crate) fn send_response(
        &self,
        request: StorageServiceRequest,
        response: diem_storage_service_types::Result<StorageServiceResponse>,
        response_sender: ResponseSender,
    ) {
    ...
    fn process_cachable_request(
        ...
        peer_network_id: &PeerNetworkId,
        request: &StorageServiceRequest,
    ) -> diem_storage_service_types::Result<StorageServiceResponse, Error> {
        increment_counter(
    ...
    ) -> diem_storage_service_types::Result<DataResponse, Error> {
...
fn log_storage_response(
    ...
    storage_response: &diem_storage_service_types::Result<
