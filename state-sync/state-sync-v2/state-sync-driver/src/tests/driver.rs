...
use diem_config::config::{NodeConfig, RoleType, StateSyncDriverConfig};
use diem_consensus_notifications::{ConsensusNotificationSender, ConsensusNotifier};
use diem_data_client::client::DiemDataClient;
use diem_data_streaming_service::streaming_client::new_streaming_service_client_listener_pair;
use diem_db::DiemDB;
use diem_event_notifications::{
...
async fn create_driver_for_tests(
    ...
    let (consensus_notifier, consensus_listener) =
        diem_consensus_notifications::new_consensus_notifier_listener_pair(5000);
