...
use diem_config::config::StateSyncDriverConfig;
use diem_data_streaming_service::data_notification::NotificationId;
use diem_event_notifications::EventSubscriptionService;
use diem_executor_types::{ChunkCommitNotification, ChunkExecutorTrait};
use diem_infallible::Mutex;
use diem_logger::prelude::*;
use diem_mempool_notifications::MempoolNotificationSender;
use diem_storage_interface::{DbReader, DbReaderWriter, StateSnapshotReceiver};
use diem_types::{
        ...
        while let Some(notification_id) = committer_listener.next().await {
            ...
            match result {
                Ok(notification) => {
                    ...
                    // storage. See: https://github.com/aptos-labs/diem-core/issues/553
