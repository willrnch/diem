...
use crate::{client::DiemDataClient, error::Error, poller::poll_peer, tests::mock::MockNetwork};
use diem_config::{config::DiemDataClientConfig, network_id::PeerNetworkId};
use diem_storage_service_types::StorageServiceError;
...
fn get_num_in_flight_polls(client: DiemDataClient, is_priority_peer: bool) -> u64 {
    if is_priority_peer {
