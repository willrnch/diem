...
use diem_config::{config::DiemDataClientConfig, network_id::PeerNetworkId};
use diem_logger::{debug, info, sample, sample::SampleRate, warn};
...
pub struct DataSummaryPoller {
    data_client_config: DiemDataClientConfig, // The configuration for the data client
    data_client: DiemDataClient,              // The data client through which to poll peers
