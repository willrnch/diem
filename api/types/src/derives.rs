...
//! documentation within `crates/diem-openapi`.
//!
...
//! <https://github.com/aptos-labs/diem-core/issues/2319>
...
// https://github.com/aptos-labs/diem-core/pull/2703
...
use diem_openapi::{impl_poem_parameter, impl_poem_type};
use indoc::indoc;
use serde_json::json;
...
impl_poem_type!(
    ...
    (
        ...
        description = Some(indoc! {"
            A hex encoded 32 byte Diem account address.
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::diem_coin::transfer".to_string()
        )),
        description = Some(indoc! {"
...
impl_poem_type!(
    ...
    "string",
    (
        example = Some(serde_json::Value::String("0x1::diem_coin".to_string())),
        description = Some(indoc! {"
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::coin::CoinStore<0x1::diem_coin::DiemCoin>".to_string()
        )),
...
impl_poem_type!(
    ...
    (
        ...
        description = Some(indoc! {"
            ...
            Move `address` type value (32 byte Diem account address) is serialized into a HexEncodedBytes string.
            For example:
              - `0x1`
            ...
            **Special serialization for Move stdlib types**:
              - [0x1::string::String](https://github.com/aptos-labs/diem-core/blob/main/language/move-stdlib/docs/ascii.md)
        ...
        description = Some(indoc! {"
            String representation of an on-chain Move type tag that is exposed in transaction payload.
                ...
                Vector type value examples:
                  - `vector<u8>`
                  - `vector<vector<u64>>`
                  - `vector<0x1::coin::CoinStore<0x1::diem_coin::DiemCoin>>`
