...
use crate::{
    Address, DiemError, EntryFunctionId, EventGuid, HashValue, HexEncodedBytes,
...
pub struct TransactionOnChainData {
    ...
    pub changes: diem_types::write_set::WriteSet,
}
...
/// Enum of the different types of transactions in Diem
