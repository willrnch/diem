...
use diem_api_types::{mime_types::JSON, DiemError, DiemErrorCode};
use poem::{
...
/// be a JSON representation of DiemError. For our own code, this is exactly
...
fn build_error_response(error_string: String) -> Response {
    Json(DiemError::new_with_error_code(
        error_string,
