...
use diem_api_types::{
    verify_field_identifier, Address, DiemErrorCode, AsConverter, IdentifierWrapper, LedgerInfo,
...
impl EventsApi {
    ...
    async fn get_events_by_creation_number(
        &self,
        accept_type: AcceptType,
        /// Hex-encoded 32 byte Diem account, with or without a `0x` prefix, for
