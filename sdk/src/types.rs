...
/// LocalAccount represents an account on the Diem blockchain. Internally it
...
impl LocalAccount {
    ...
    /// does not actually create an account on the Diem blockchain, just a
    ...
    /// create an account on the Diem blockchain, it just generates a new
    /// account locally.
