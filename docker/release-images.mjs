...
// This script releases the main diem docker images to docker hub.
// It does so by copying the images from diem GCP artifact registry to docker hub.
...
// 2. docker login - with authorization to push to the `diemlabs` org
...
const AWS_ECR = `${parsedArgs.AWS_ACCOUNT_ID}.dkr.ecr.us-west-2.amazonaws.com/diem`;
...
const DOCKERHUB = "docker.io/diemlabs";
