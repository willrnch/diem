...
use diem_executor_benchmark::{native_executor::NativeExecutor, pipeline::PipelineConfig};
use diem_metrics_core::{register_int_gauge, IntGauge};
    ...
    E: TransactionBlockExecutor + 'static,
{
    match opt.cmd {
        Command::CreateDb {
            ...
            diem_executor_benchmark::db_generator::create_db_with_accounts::<E>(
                num_accounts,
                init_account_balance,
                opt.block_size,
                data_dir,
        ...
        Command::RunExecutor {
            ...
            diem_executor_benchmark::run_benchmark::<E>(
                opt.block_size,
                blocks,
        ...
        Command::AddAccounts {
            ...
            diem_executor_benchmark::add_accounts::<E>(
                num_new_accounts,
                init_account_balance,
                opt.block_size,
                data_dir,
...
fn main() {
    ...
    DiemVM::set_concurrency_level_once(opt.concurrency_level());
    DiemVM::set_num_shards_once(opt.pipeline_opt.num_executor_shards);
