...
use diem_scratchpad::{ProofRead, SparseMerkleTree};
use diem_types::{
...
pub struct StateComputeResult {
    ...
    /// after the execution. For details, please see [`InMemoryAccumulator`](diem_types::proof::accumulator::InMemoryAccumulator).
