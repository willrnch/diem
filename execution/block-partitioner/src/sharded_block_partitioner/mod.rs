...
use diem_metrics_core::{exponential_buckets, register_histogram, Histogram};
use diem_types::{
...
impl ShardedBlockPartitioner {
    ...
    pub fn partition(
        ...
        let _timer = DIEM_BLOCK_PARTITIONER_SECONDS.start_timer();
...
pub static DIEM_BLOCK_PARTITIONER_SECONDS: Lazy<Histogram> = Lazy::new(|| {
    register_histogram!(
        // metric name
        "diem_block_partitioner_seconds",
        // metric description
