...
pub static DIEM_EXECUTOR_OTHER_TIMERS_SECONDS: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        // metric name
        "diem_executor_other_timers_seconds",
        // metric description
        "The time spent in seconds of others in Diem executor",
        &["name"],
        exponential_buckets(/*start=*/ 1e-3, /*factor=*/ 2.0, /*count=*/ 20).unwrap(),
    )
    .unwrap()
...
pub static DIEM_PROCESSED_TXNS_COUNT: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "diem_processed_txns_count",
...
/// Count of the executed transactions since last restart.
pub static DIEM_PROCESSED_FAILED_TXNS_REASON_COUNT: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "diem_processed_failed_txns_reason_count",
        "Count of the transactions since last restart. state is success, failed or retry",
...
pub static DIEM_PROCESSED_USER_TRANSACTIONS_PAYLOAD_TYPE: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "diem_processed_user_transactions_by_payload",
...
pub static DIEM_PROCESSED_USER_TRANSACTIONS_ENTRY_FUNCTION_MODULE: Lazy<IntCounterVec> =
    Lazy::new(|| {
        register_int_counter_vec!(
            "diem_processed_user_transactions_entry_function_by_module",
...
pub static DIEM_PROCESSED_USER_TRANSACTIONS_ENTRY_FUNCTION_CORE_METHOD: Lazy<IntCounterVec> =
    Lazy::new(|| {
        register_int_counter_vec!(
            "diem_processed_user_transactions_entry_function_by_core_method",
...
/// Counter of executed EntryFunction user transaction for core address by method
pub static DIEM_PROCESSED_USER_TRANSACTIONS_CORE_EVENTS: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "diem_processed_user_transactions_core_events",
        "Counter of processed EntryFunction user transaction for core address by method",
