...
use crate::{
    ...
    metrics::{
        ...
        DIEM_EXECUTOR_OTHER_TIMERS_SECONDS, DIEM_EXECUTOR_SAVE_TRANSACTIONS_SECONDS,
        DIEM_EXECUTOR_TRANSACTIONS_SAVED, DIEM_EXECUTOR_VM_EXECUTE_BLOCK_SECONDS,
    },
};
use anyhow::Result;
use diem_crypto::HashValue;
use diem_executor_types::{BlockExecutorTrait, Error, StateComputeResult};
...
impl TransactionBlockExecutor for DiemVM {
    fn execute_transaction_block(
        transactions: ExecutableTransactions<Transaction>,
        state_view: CachedStateView,
        maybe_block_gas_limit: Option<u64>,
    ) -> Result<ChunkOutput> {
        ChunkOutput::by_transaction_execution::<DiemVM>(
            transactions,
            state_view,
