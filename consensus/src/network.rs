...
pub struct NetworkReceivers {
    ...
    >,
    pub buffer_manager_messages: diem_channel::Receiver<
        (AccountAddress, Discriminant<ConsensusMsg>),
        (AccountAddress, ConsensusMsg),
    >,
    pub quorum_store_messages: diem_channel::Receiver<
        (AccountAddress, Discriminant<ConsensusMsg>),
        (AccountAddress, ConsensusMsg),
    >,
    pub rpc_rx: diem_channel::Receiver<AccountAddress, (AccountAddress, IncomingRpcRequest)>,
}
...
pub struct NetworkTask {
    consensus_messages_tx: diem_channel::Sender<
        ...
        (AccountAddress, ConsensusMsg),
    >,
    buffer_manager_messages_tx: diem_channel::Sender<
        (AccountAddress, Discriminant<ConsensusMsg>),
        (AccountAddress, ConsensusMsg),
    >,
    quorum_store_messages_tx: diem_channel::Sender<
        (AccountAddress, Discriminant<ConsensusMsg>),
        (AccountAddress, ConsensusMsg),
    >,
    rpc_tx: diem_channel::Sender<AccountAddress, (AccountAddress, IncomingRpcRequest)>,
...
impl NetworkTask {
    ...
    pub fn new(
        ...
        self_receiver: diem_channels::Receiver<Event<ConsensusMsg>>,
        ...
        let (buffer_manager_messages_tx, buffer_manager_messages) = diem_channel::new(
            QueueStyle::FIFO,
            100,
            Some(&counters::BUFFER_MANAGER_CHANNEL_MSGS),
        );
        let (quorum_store_messages_tx, quorum_store_messages) = diem_channel::new(
            QueueStyle::FIFO,
        ...
        let (rpc_tx, rpc_rx) =
            diem_channel::new(QueueStyle::LIFO, 1, Some(&counters::RPC_CHANNEL_MSGS));
