...
use anyhow::Result;
use diem_consensus_types::proof_of_store::BatchId;
...
impl Schema for BatchSchema {
    ...
    const COLUMN_FAMILY_NAME: diem_schemadb::ColumnFamilyName = BATCH_CF_NAME;
}
...
impl Schema for BatchIdSchema {
    ...
    const COLUMN_FAMILY_NAME: diem_schemadb::ColumnFamilyName = BATCH_ID_CF_NAME;
}
