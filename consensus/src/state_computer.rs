...
use diem_consensus_types::{block::Block, common::Round, executed_block::ExecutedBlock};
use diem_crypto::HashValue;
use diem_executor_types::{BlockExecutorTrait, Error as ExecutionError, StateComputeResult};
...
pub struct ExecutionProxy {
    ...
    async_state_sync_notifier: diem_channels::Sender<NotificationType>,
...
impl ExecutionProxy {
    pub fn new(
        ...
        let (tx, mut rx) =
            diem_channels::new::<NotificationType>(10, &counters::PENDING_STATE_SYNC_NOTIFICATION);
...
async fn test_commit_sync_race() {
    ...
    use diem_consensus_notifications::Error;
    use diem_types::{
