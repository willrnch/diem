...
use diem_logger::{error, warn};
use diem_network::protocols::network::RpcError;
use diem_types::{epoch_state::EpochState, validator_signer::ValidatorSigner};
use bytes::Bytes;
use futures::StreamExt;
use std::sync::Arc;

struct NetworkHandler {
    dag_rpc_rx: diem_channel::Receiver<Author, IncomingDAGRequest>,
