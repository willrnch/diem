...
use diem::common::types::{EncodingOptions, PrivateKeyInputOptions, ProfileOptions};
use diem_logger::info;
use diem_rosetta::types::TransactionIdentifier;
...
pub struct CreateAccountCommand {
    ...
    #[clap(long, value_parser = diem::common::types::load_account_arg)]
