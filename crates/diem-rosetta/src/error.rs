...
use diem_rest_client::{diem_api_types::DiemErrorCode, error::RestError};
    ...
    fn from(err: RestError) -> Self {
        match err {
            RestError::Api(err) => match err.error.error_code {
                ...
                DiemErrorCode::ModuleNotFound => ApiError::ModuleNotFound(Some(err.error.message)),
                ...
                DiemErrorCode::BlockNotFound => ApiError::BlockNotFound(Some(err.error.message)),
                DiemErrorCode::StateValueNotFound => {
                    ApiError::StateValueNotFound(Some(err.error.message))
                },
                DiemErrorCode::VersionPruned => ApiError::VersionPruned(Some(err.error.message)),
                DiemErrorCode::BlockPruned => ApiError::BlockPruned(Some(err.error.message)),
                DiemErrorCode::InvalidInput => ApiError::InvalidInput(Some(err.error.message)),
                ...
                DiemErrorCode::VmError => ApiError::VmError(Some(err.error.message)),
                DiemErrorCode::HealthCheckFailed => {
                    ApiError::InternalError(Some(err.error.message))
                },
                DiemErrorCode::MempoolIsFull => ApiError::MempoolIsFull(Some(err.error.message)),
                DiemErrorCode::WebFrameworkError => {
                    ApiError::InternalError(Some(err.error.message))
                },
                DiemErrorCode::BcsNotSupported => ApiError::InvalidInput(Some(err.error.message)),
                DiemErrorCode::InternalError => ApiError::InternalError(Some(err.error.message)),
                DiemErrorCode::ApiDisabled => ApiError::InternalError(Some(err.error.message)),
            },
