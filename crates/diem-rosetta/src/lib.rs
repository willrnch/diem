...
use diem_warp_webserver::{logger, Error, WebServer};
...
pub struct RosettaContext {
    ...
    rest_client: Option<Arc<diem_rest_client::Client>>,
...
impl RosettaContext {
    ...
    fn rest_client(&self) -> ApiResult<Arc<diem_rest_client::Client>> {
...
pub fn bootstrap(
    ...
    rest_client: Option<diem_rest_client::Client>,
    owner_addresses: Vec<AccountAddress>,
) -> anyhow::Result<tokio::runtime::Runtime> {
    let runtime = diem_runtimes::spawn_named_runtime("rosetta".into(), None);
