...
/// 1. Download the package - diem move download
/// 2. Compile the package - diem move compile
/// 3. Cd to package and disassemble - diem move disassemble --bytecode-path ./test.mv
#[derive(Debug, Parser)]
