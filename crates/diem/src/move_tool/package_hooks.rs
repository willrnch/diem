...
use diem_framework::UPGRADE_POLICY_CUSTOM_FIELD;
...
pub fn register_package_hooks() {
    move_package::package_hooks::register_package_hooks(Box::new(DiemPackageHooks {}))
}

struct DiemPackageHooks {}

impl PackageHooks for DiemPackageHooks {
