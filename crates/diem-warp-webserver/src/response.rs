...
use diem_api_types::{
    mime_types::{BCS, JSON},
    LedgerInfo, X_DIEM_BLOCK_HEIGHT, X_DIEM_CHAIN_ID, X_DIEM_EPOCH,
    X_DIEM_LEDGER_OLDEST_VERSION, X_DIEM_LEDGER_TIMESTAMP, X_DIEM_LEDGER_VERSION,
    X_DIEM_OLDEST_BLOCK_HEIGHT,
};
...
impl warp::Reply for Response {
    fn into_response(self) -> warp::reply::Response {
        ...
        headers.insert(X_DIEM_EPOCH, self.ledger_info.epoch.0.into());
        headers.insert(X_DIEM_BLOCK_HEIGHT, self.ledger_info.block_height.0.into());
        headers.insert(
            X_DIEM_OLDEST_BLOCK_HEIGHT,
