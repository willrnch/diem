...
impl serde::Serialize for GetTransactionsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("diem.indexer.v1.GetTransactionsRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for GetTransactionsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct diem.indexer.v1.GetTransactionsRequest")
            }
        ...
        deserializer.deserialize_struct("diem.indexer.v1.GetTransactionsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TransactionsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("diem.indexer.v1.TransactionsResponse", len)?;
        if !self.transactions.is_empty() {
...
impl<'de> serde::Deserialize<'de> for TransactionsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct diem.indexer.v1.TransactionsResponse")
            }
        ...
        deserializer.deserialize_struct("diem.indexer.v1.TransactionsResponse", FIELDS, GeneratedVisitor)
    }
}
