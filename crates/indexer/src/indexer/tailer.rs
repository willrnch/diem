...
use diem_api::context::Context as ApiContext;
...
mod test {
    ...
    use diem_api_test_context::new_test_context;
    use diem_api_types::{LedgerInfo as APILedgerInfo, Transaction, U64};
    ...
    async fn test_parsing_and_writing() {
        ...
        if let Transaction::BlockMetadataTransaction(ref mut bmt) = block_metadata_transaction {
            bmt.info.epoch = Some(diem_api_types::U64::from(1));
        }
