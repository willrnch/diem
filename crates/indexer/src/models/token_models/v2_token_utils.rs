...
use diem_api_types::{deserialize_from_string, Event, WriteResource};
...
pub struct TokenV2AggregatedData {
    pub diem_collection: Option<DiemCollection>,
...
impl DiemCollection {
    pub fn from_write_resource(
        ...
        if let V2TokenResource::DiemCollection(inner) =
...
impl V2TokenResource {
    ...
    pub fn from_resource(
        ...
        match data_type {
            ...
            "0x4::diem_token::DiemCollection" => {
                serde_json::from_value(data.clone()).map(|inner| Some(Self::DiemCollection(inner)))
            },
            "0x4::token::Token" => {
