...
//! ```
//! use std::iter::zip;
//! use diem_crypto::test_utils::{KeyPair, TestDiemCrypto};
//! use diem_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use diem_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
...
//! //
//! // Here, we'll sign an existing testing struct from `crates/diem-crypto/src/test_utils.rs`:
//! //
...
//! use diem_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use diem_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use diem_crypto::bls12381::{ProofOfPossession, UnvalidatedPublicKey};
//! use diem_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
//! use serde::{Serialize, Deserialize};
//! use diem_crypto::validatable::Validatable;
//!
//! // NOTE: These were generated by running `cargo test -- doc_test --ignored --nocapture` in `crates/diem-crypto/`
...
//! // signature on TestDiemCrypto("test".to_owned())
