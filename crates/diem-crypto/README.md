...
id: crypto
title: Crypto
custom_edit_url: https://github.com/aptos-labs/diem-core/edit/main/crypto/crypto/README.md
---

The crypto component hosts all the implementations of cryptographic primitives we use in Diem: hashing, signatures, multisignatures, aggregate signatures, and key derivation/generation.
