...
use diem_channels::{diem_channel, diem_channel::Receiver, message_queues::QueueStyle};
use diem_config::{
    config::PeerRole,
...
use diem_peer_monitoring_service_server::network::{NetworkRequest, ResponseSender};
use diem_peer_monitoring_service_types::PeerMonitoringServiceMessage;
use diem_time_service::TimeService;
use diem_types::account_address::{AccountAddress as PeerId, AccountAddress};
...
impl MockMonitoringServer {
    pub fn new(
        ...
        for network_id in &all_network_ids {
            ...
            let queue_config = diem_channel::Config::new(10).queue_style(QueueStyle::FIFO);
