...
use diem_network::protocols::network::RpcError;
...
pub enum Error {
    ...
    #[error("Diem network rpc error: {0}")]
...
impl From<diem_network::application::error::Error> for Error {
    fn from(error: diem_network::application::error::Error) -> Self {
