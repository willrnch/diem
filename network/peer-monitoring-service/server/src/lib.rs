...
use diem_network::application::storage::PeersAndMetadata;
...
impl<T: StorageReaderInterface> Handler<T> {
    ...
    fn get_node_information(&self) -> Result<PeerMonitoringServiceResponse, Error> {
        ...
        let build_information = diem_build_info::get_build_information();
    ...
    fn handle_performance_monitoring_request(
        &self,
        performance_monitoring_request: &diem_peer_monitoring_service_types::request::PerformanceMonitoringRequest,
    ) -> Result<PeerMonitoringServiceResponse, Error> {
        let performance_monitoring_response =
            diem_peer_monitoring_service_types::response::PerformanceMonitoringResponse {
