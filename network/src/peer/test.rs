...
fn build_test_peer(
    ...
    PeerHandle,
    MemorySocket,
    diem_channels::Receiver<TransportNotification<MemorySocket>>,
    ...
    let (connection_notifs_tx, connection_notifs_rx) = diem_channels::new_test(1);
...
async fn assert_disconnected_event(
    ...
    connection_notifs_rx: &mut diem_channels::Receiver<TransportNotification<MemorySocket>>,
) {
