...
import { DiemClient, DiemAccount, FaucetClient, BCS, TxnBuilderTypes, Provider, Network, TokenClient } from "diem";
...
(async () => {
  ...
  let accountResource = resources.find((r: any) => r.type === diemCoinStore);
  ...
  accountResource = resources.find((r: any) => r.type === diemCoinStore);
