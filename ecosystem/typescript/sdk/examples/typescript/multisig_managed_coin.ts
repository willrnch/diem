...
const approve = async (client: Provider, owner: DiemAccount, multisigAddress: string, transactionId: number) => {
...
const getNamedObjectAddress = (owner: DiemAccount, seed: string): TxnBuilderTypes.AccountAddress => {
