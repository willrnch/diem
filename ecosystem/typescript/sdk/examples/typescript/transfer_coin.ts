...
import { DiemClient, DiemAccount, CoinClient, FaucetClient } from "diem";
...
(async () => {
  ...
  const bob = new DiemAccount(); // <:!:section_2
  ...
  // Have Alice send Bob some DiemCoins.
  // :!:>section_5
  ...
  // Have Alice send Bob some more DiemCoins.
