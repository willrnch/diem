...
echo 'Generated from `ecosystem/typescript/sdk/` in [diem-core](https://github.com/aptos-labs/diem-core/tree/main/ecosystem/typescript/sdk) using `pnpm generate-ts-docs`.' >> $DOCS_DIR/README.md
