 ...
 * used by the Diem Blockchain. The test vectors are arrays of JSON objects.
...
const ENTRY_FUNCTION_VECTOR = path.join(
  ...
  "diem_api__tests__transaction_vector_test__test_entry_function_payload.json",
);

const SCRIPT_VECTOR = path.join(
  VECTOR_FILES_ROOT_DIR,
  "diem_api__tests__transaction_vector_test__test_script_payload.json",
);
