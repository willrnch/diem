...
export class RawTransaction {
  /**
   * RawTransactions contain the metadata and payloads that can be submitted to Diem chain for execution.
   * RawTransactions must be signed before Diem chain can execute them.
   *
   * @param sender Account address of the sender.
   * @param sequence_number Sequence number of this transaction. This must match the sequence number stored in
   *   the sender's account at the time the transaction executes.
   * @param payload Instructions for the Diem Blockchain, including publishing a module,
...
export class Script {
  /**
   * Scripts contain the Move bytecodes payload that can be submitted to Diem chain for execution.
...
export class Module {
  /**
   * Contains the bytecode of a Move module that can be published to the Diem chain.
...
export class SignedTransaction {
   ...
   *
   * @see {@link https://diem.dev/guides/creating-a-signed-transaction/ | Creating a Signed Transaction}
   *
   * @param raw_txn
