...
import { ApiError } from "./diem_client";
...
/**
 * Provides methods for retrieving data from Diem Indexer.
 * For more detailed Queries specification see
 * {@link https://cloud.hasura.io/public/graphiql?endpoint=https://indexer.mainnet.diemlabs.com/v1/graphql}
 */
export class IndexerClient {
  ...
  /**
   * @param endpoint URL of the Diem Indexer API endpoint.
   */
  ...
  /**
   * Makes axios client call to fetch data from Diem Indexer.
   *
  ...
  /**
   * Queries an Diem account's NFTs by owner address
   *
   * @param ownerAddress Hex-encoded 32 byte Diem account address
