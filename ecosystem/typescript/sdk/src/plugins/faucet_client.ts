 ...
 */
export class FaucetClient extends DiemClient {
  readonly faucetUrl: string;

  readonly config: ClientConfig | undefined;

  /**
   * Establishes a connection to Diem node
   * @param nodeUrl A url of the Diem Node API endpoint
   ...
   * @param address Hex-encoded 16 bytes Diem account address wich mints tokens
