...
use diem_protos::transaction::v1::{
...
const GAS_FEE_EVENT: &str = "0x1::diem_coin::GasFeeEvent";
...
impl CoinActivity {
    ...
    fn get_gas_event(
        ...
        Self {
            ...
            coin_type: DIEM_COIN_TYPE_STR.to_string(),
            amount: diem_coin_burned,
