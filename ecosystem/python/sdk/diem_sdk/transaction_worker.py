...
from diem_sdk.transactions import SignedTransaction, TransactionPayload
...
from diem_sdk.transactions import EntryFunction, TransactionArgument
...
class Test(unittest.IsolatedAsyncioTestCase):
    async def test_common_path(self):
        ...
        seq_num_patcher = unittest.mock.patch(
            "diem_sdk.async_client.RestClient.account_sequence_number", return_value=0
        )
        seq_num_patcher.start()
        submit_txn_patcher = unittest.mock.patch(
            "diem_sdk.async_client.RestClient.submit_bcs_transaction",
            return_value="0xff",
        )
        submit_txn_patcher.start()

        rest_client = RestClient("https://fullnode.devnet.diemlabs.com/v1")
