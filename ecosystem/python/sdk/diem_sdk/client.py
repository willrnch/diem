...
class RestClient:
    """A wrapper around the Diem-core Rest API"""
    ...
    def __init__(self, base_url: str, client_config: ClientConfig = ClientConfig()):
        ...
        self.client.headers[Metadata.DIEM_HEADER] = Metadata.get_diem_header_val()
    ...
    def simulate_transaction(
        ...
        headers = {"Content-Type": "application/x.diem.signed_transaction+bcs"}
        response = self.client.post(
    ...
    def bcs_transfer(
        ...
        payload = EntryFunction.natural(
            "0x1::diem_account",
            "transfer_coins",
            [TypeTag(StructTag.from_str("0x1::diem_coin::DiemCoin"))],
            transaction_arguments,
        )
