...
from diem_sdk.async_client import ApiError, RestClient
...
class Test(unittest.IsolatedAsyncioTestCase):
    async def test_common_path(self):
        ...
        * Ensure that synchronize completes if the value matches on-chain
        ...
        patcher.stop()
        patcher = unittest.mock.patch(
            "diem_sdk.async_client.RestClient.account_sequence_number", return_value=5
        )
        patcher.start()
        ...
        patcher.stop()
        patcher = unittest.mock.patch(
            "diem_sdk.async_client.RestClient.account_sequence_number",
