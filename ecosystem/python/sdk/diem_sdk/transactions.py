...
"""
This translates Diem transactions to and from BCS for signing and submitting to the REST API.
"""
...
"""
    ...
    def prehash(self) -> bytes:
        ...
        hasher.update(b"DIEM::RawTransaction")
...
class MultiAgentRawTransaction:
    ...
    def prehash(self) -> bytes:
        hasher = hashlib.sha3_256()
        hasher.update(b"DIEM::RawTransactionWithData")
        return hasher.digest()
