...
One method to do so is to use the CLI:
    ...
    * `python -m examples.your-coin ~/diem-core/diem-move/move-examples/moon_coin`.
...
from diem_sdk.account_address import AccountAddress
from diem_sdk.bcs import Serializer
from diem_sdk.client import FaucetClient, RestClient
from diem_sdk.transactions import (
    EntryFunction,
    TransactionArgument,
    TransactionPayload,
)
from diem_sdk.type_tag import StructTag, TypeTag
