...
from diem_sdk.account import Account, RotationProofChallenge
from diem_sdk.account_address import AccountAddress
from diem_sdk.authenticator import Authenticator, MultiEd25519Authenticator
from diem_sdk.bcs import Serializer
from diem_sdk.client import FaucetClient, RestClient
from diem_sdk.ed25519 import MultiPublicKey, MultiSignature
...
if __name__ == "__main__":
    ...
    entry_function = EntryFunction.natural(
        module="0x1::coin",
        function="transfer",
        ty_args=[TypeTag(StructTag.from_str("0x1::diem_coin::DiemCoin"))],
        args=[
    ...
    packages_dir = "../../../../diem-move/move-examples/upgrade_and_govern/"
    ...
    print(f"Running diem CLI command: {command}\n")
