...
from diem_sdk.account_sequence_number import AccountSequenceNumber
from diem_sdk.diem_token_client import DiemTokenClient, Property, PropertyMap
from diem_sdk.async_client import ClientConfig, FaucetClient, RestClient
from diem_sdk.bcs import Serializer
from diem_sdk.transaction_worker import TransactionWorker
...
async def token_transaction(
    ...
    if sequence_number == 8351:
        payload = DiemTokenClient.create_collection_payload(
        ...
        payload = DiemTokenClient.mint_token_payload(
            collection_name,
