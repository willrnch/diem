...
One method to do so is to use the CLI:
    * Acquire the Diem CLI
    * `cd ~`
    * `diem init`
    * `cd ~/diem-core/diem-move/move-examples/hello_blockchain`
    * `diem move publish --named-addresses hello_blockchain=${your_address_from_diem_init}`
    * `python -m examples.hello-blockchain ${your_address_from_diem_init}`
"""
