...
use diem_rest_client::Client as DiemRestClient;
use diem_sdk::types::network_address::NetworkAddress;
...
impl NodeAddress {
    ...
    pub fn get_api_client(&self, timeout: Duration) -> Result<DiemRestClient> {
        ...
        Ok(DiemRestClient::from((client, self.get_api_url()?)))
    }
