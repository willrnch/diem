...
use diem_sdk::crypto::{ed25519::Ed25519PrivateKey, PrivateKey};
...
impl NetworkTest for FrameworkUpgrade {
    fn run(&self, ctx: &mut NetworkContext<'_>) -> Result<()> {
        ...
        let network_info = diem_release_builder::validate::NetworkConfig {
        ...
        let release_config = diem_release_builder::current_release_config();

        runtime.block_on(diem_release_builder::validate::validate_config(
