...
use diem::common::types::EncodingType;
use diem_config::{
...
use diem_genesis::builder::{FullnodeNodeConfig, InitConfigFn, InitGenesisConfigFn};
...
impl LocalSwarm {
        ...
        R: ::rand::RngCore + ::rand::CryptoRng,
    {
        ...
        let (root_key, genesis, genesis_waypoint, validators) =
            diem_genesis::builder::Builder::new(
                &dir_actual,
                genesis_framework
                    .unwrap_or_else(|| diem_cached_packages::head_release_bundle().clone()),
            )?
        ...
        let root_account = LocalAccount::new(
            diem_sdk::types::account_config::diem_test_root_address(),
